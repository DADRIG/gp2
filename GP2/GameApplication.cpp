...
bool CGameApplication::initGraphics()
{
	...
	if (FAILED(D3D10CreateDeviceAndSwapChain(NULL,D3D10_DRIVER_TYPE_HARDWARE,NULL,createDeviceFlags,D3D10_SDK_VERSION,&sd,&m_pSwapChain,
		&m_pD3D10Device)))
		return false;
	...
	float ClearColor[4] = {0.0f,0.0125f,0.3f,1.0f};
